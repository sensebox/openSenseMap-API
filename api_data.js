define({ "api": [
  ...
  },
  {
    ...
    "description": "<p>This will delete all the measurements of the senseBox. Please note that the deletion isn't happening immediately.</p>",
    "name": "deleteBox",
    "group": "Boxes",
    "parameter": {
      "fields": {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "_id",
            "description": "<p>unique identifier of this senseBox</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "model",
            "description": "<p>the model of this senseBox</p>"
          },
          {
            "group": "Success 200",
            "type": "RFC3339Date",
            "optional": false,
            "field": "lastMeasurementAt",
            "description": "<p>timestamp of the lastest measurement of one of the sensors of this senseBox</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": true,
            "field": "weblink",
            "description": "<p>external weblink</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": true,
            "field": "description",
            "description": "<p>detailed description of the senseBox</p>"
          },
          {
            "group": "Success 200",
            "type": "RFC3339Date",
            "optional": false,
            "field": "createdAt",
            "description": "<p>timestamp of the creation date of the senseBox</p>"
          },
          {
            "group": "Success 200",
            "type": "RFC3339Date",
            "optional": false,
            "field": "updatedAt",
            "description": "<p>timestamp of last update of the senseBox</p>"
          },
          {
            "group": "Success 200",
            "type": "String[]",
            "optional": false,
            "field": "grouptag",
            "description": "<p>the grouptags of this senseBox</p>"
          },
          {
            "group": "Success 200",
            "type": "Object",
          ...
          },
          {
            ...
            "type": "Coordinates[]",
            "optional": false,
            "field": "currentLocation.coordinates",
            "description": "<p>of the latest location of the senseBox</p>"
          },
          {
            "group": "Success 200",
            "type": "RFC3339Date",
            "optional": false,
            "field": "currentLocation.timestamp",
            "description": "<p>timestamp of the location</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "currentLocation.coordinates.type",
            "description": "<p>type of the coordinates</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": true,
            "field": "image",
            "description": "<p>image showing the senseBox</p>"
          },
          {
            "group": "Success 200",
            "type": "Sensor[]",
            "optional": false,
            "field": "sensors",
            "description": "<p>Array containing sensor objects</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "sensors._id",
            "description": "<p>unique identifier of the sensor</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "sensors.sensorType",
            "description": "<p>sensorType the type of the sensor.</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
          ...
          },
          {
            ...
            "type": "Object",
            "optional": false,
            "field": "sensors.lastMeasurement",
            "description": "<p>Object representing the latest measruement</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "sensors.lastMeasurement.value",
            "description": "<p>the measured value of the sensor</p>"
          },
          {
            "group": "Success 200",
            "type": "RFC3339Date",
            "optional": false,
            "field": "sensor.lastMeasurement.createdAt",
            "description": "<p>the timestamp of the measurement</p>"
          }
        ]
      }
    },
  ...
  },
  {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "field": "maxDistance",
            "defaultValue": "1000",
            "description": "<p>the amount of meters around the near Parameter that the api will search for senseBoxes</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
    ...
    "success": {
      "examples": [
        {
          "title": "Example response for :minimal=true",
        ...
        {
          "title": "Example response for :minimal=true and :classify=true",
          "content": "[\n {\n      \"_id\": \"5ee91626dc1438001b473b52\",\n      \"name\": \"Lucht sensor\",\n      \"currentLocation\": {\n        \"timestamp\": \"2020-06-16T18:57:42.322Z\",\n        \"coordinates\": [\n          5.38517,\n          51.426135\n        ],\n        \"type\": \"Point\"\n      },\n      \"exposure\": \"outdoor\",\n      \"lastMeasurementAt\": \"2020-06-16T20:51:23.414Z\",\n      \"state\": \"old\"\n    },\n    {\n      \"_id\": \"5ee92557dc1438001b4d3eee\",\n      \"name\": \"BabCity\",\n      \"currentLocation\": {\n        \"timestamp\": \"2020-06-16T20:02:31.083Z\",\n        \"coordinates\": [\n          4.78833,\n          51.936062\n        ],\n        \"type\": \"Point\"\n      },\n      \"exposure\": \"outdoor\",\n      \"lastMeasurementAt\": \"2022-01-23T20:14:48.808Z\",\n      \"state\": \"old\"\n    }\n]",
          "type": "application/json"
        }
      ]
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "windSpeedPort",
            "description": "<p>the digital port the windspeed sensor is connected to</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "optional": true,
            "field": "devEUI",
            "description": "<p>the devEUI of TTN device</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "appEUI",
            "description": "<p>the appEUI of TTN application</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "appKey",
            "description": "<p>the appKey of TTN application</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            ...
            "description": "<p>include code for an attached oled display</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "RequestBody": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "description",
            "description": "<p>detailed description of this senseBox.</p>"
          },
          {
            "group": "RequestBody",
            "type": "String",
      ...
      "examples": [
        {
          ...
          "content": "{ \"lng\": 7.684, \"lat\": 51.972, \"height\": 66.6 }",
          "type": "application/json"
        },
        {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "measurement",
            "description": "<p>Array containing queried measurements</p>"
          },
          {
            "group": "Success 200",
            "type": "String[]",
          ...
          },
          {
            ...
            "type": "RFC3339Date",
            "optional": false,
            "field": "measurement.createdAt",
            "description": "<p>timestamp of the measurement</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "deprecated": {
      "content": "Will change in the upcoming release to /boxes/data?grouptag=:grouptag"
    },
    "group": "Measurements",
  ...
  {
    "type": "get",
    "url": "/boxes/:senseBoxId/sensors/:sensorId",
    "title": "Get latest measurements of a sensor",
    "description": "<p>Get the latest measurements of a sensor.</p>",
    "group": "Measurements",
        ...
        "Parameter": [
          {
            ...
            "optional": true,
            "field": "onlyValue",
            "description": "<p>If set to true only returns the measured value without information about the sensor. Requires a sensorId.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
        ...
        "Header": [
          {
            ...
            "optional": false,
            "field": "Authorization",
            "description": "<p>Box' unique access_token. Will be used as authorization token if box has auth enabled (e.g. useAuth: true)</p>"
          },
          {
            "group": "Header",
            "type": "String",
  ...
  {
    "type": "get",
    "url": "/users/me/boxes/:boxId",
    "title": "get specific box of the signed in user",
    "name": "getUserBox",
    "description": "<p>Get specific box of the signed in user with secret fields</p>",
    "group": "Users",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "page",
            "description": "<p>the selected page for pagination</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "data",
            "description": "<p>A json object with a single <code>box</code> object field</p>"
          }
        ]
      }
    },
