define({ "api": [
  ...
  },
  {
    ...
    "description": "<p>Retrieve a JSON object containing a GeoJSON FeatureCollection with a computed Inverse Distance Interpolation for a certain region of interest and phenomenon. Please be aware that requests with (areaSquareKilometers / cellWidth) &gt; 2500 will be rejected.</p>",
    "version": "0.0.1",
    "group": "Interpolation",
    "name": "calculateIdw",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "field": "cellWidth",
            "defaultValue": "50",
            "description": "<p>The width of the grid cells in kilometers</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
