...
const models = require('../models'),
  ...
  { retrieveParameters, validateBboxParam, validateFromToTimeParams } = require('../helpers/userParamHelpers'),
...
module.exports = {
  getStatistics: [
    ...
    requestUtils.addCache('5 minutes', 'getStats'),
    getStatistics
  ],
  getIdw: [
    requestUtils.retrieveParameter('bbox', 'Array,Number', true),
    requestUtils.retrieveParameter('phenomenon', 'String', true),
    requestUtils.retrieveParameter('exposure', 'String', false, models.Box.BOX_VALID_EXPOSURES),
