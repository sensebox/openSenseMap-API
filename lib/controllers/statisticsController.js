 ...
 * @apiParam {Boolean="true","false"} [replaceOutlier="true"] Define if the outlier should be replaced by the running mean (default). Otherwise outliers will be replaced with "true"
 */
  ...
  Box.findMeasurementsOfBoxesStream(
    ...
    .then(function (cursor) {
      ...
      cursor
        .pipe(outlier({
          window,
          replaceOutlier: (replaceOutlier === 'true')
        }))
...
module.exports = {
  ...
  getOutlier: [
    ...
    requestUtils.retrieveParameter('replaceOutlier', 'String', 'true', ['true', 'false']),
