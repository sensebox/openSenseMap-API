 ...
 * @apiSuccess (Created 201) {Object} data `{ "user": {"firstname":"firstname","fullname":"firstname","email":"test@test.de","role":"user","language":"en_US","boxes":[]} }`
 */
 ...
 * @apiSuccess {Object} data `{ "user": {"firstname":"firstname","lastname":"last", "fullname":"firstname last","email":"test@test.de","role":"user","language":"en_US","boxes":[]} }`
 ...
 * @apiName requestPasswordResetUser
 * @apiDescription request a password reset in case of a forgotten password
 * @apiGroup Users
 */
