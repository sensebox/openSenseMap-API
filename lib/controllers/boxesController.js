...
module.exports = {
  ...
  updateBox: [
    checkContentType,
    retrieveParameter('name', 'String', false),
    retrieveParameter('grouptag', 'String', false),
    retrieveParameter('description', 'String', false),
    retrieveParameter('image', 'String', false),
    retrieveParameter('exposure', 'String', false, ['indoor', 'outdoor']),
    retrieveParameter('mqtt', 'object', false),
    retrieveParameter('ttn', 'object', false),
    retrieveParameter('loc', 'object', false),
    retrieveParameter('sensors', 'Array', false),
    retrieveParameter('addons', 'object', false),
    updateBox
  ],
  getMeasurements,
  postNewMeasurement: [
  ...
  findAllBoxes: [
    retrieveParameter('exposure', 'String', false, ['indoor', 'outdoor']),
    retrieveParameter('model', 'Array,String', false),
    retrieveParameter('grouptag', 'Array,String', false),
    retrieveParameter('phenomenon', 'String'),
    retrieveParameter('date', 'String'),
    retrieveParameter('format', 'String', 'json', ['json', 'geojson']),
    parseAndValidateTimeParamsForFindAllBoxes,
