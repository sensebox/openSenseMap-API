...
// TODO add toJSON to box
/**
 * {"__v":0,"createdAt":"2016-12-14T10:37:28.633Z","updatedAt":"2016-12-14T10:37:28.633Z","name":"senseBox","boxType":"fixed","exposure":"indoor","_id":"585120e8d014d4637b9a9035","model":"homeEthernet","mqtt":{"url":"","topic":"","decodeOptions":"","connectionOptions":"","messageFormat":"","enabled":false},"sensors":[{"title":"Temperatur","unit":"°C","sensorType":"HDC1008","icon":"osem-thermometer","_id":"585120e8d014d4637b9a903a"},{"title":"rel. Luftfeuchte","unit":"%","sensorType":"HDC1008","icon":"osem-humidity","_id":"585120e8d014d4637b9a9039"},{"title":"Luftdruck","unit":"hPa","sensorType":"BMP280","icon":"osem-barometer","_id":"585120e8d014d4637b9a9038"},{"title":"Beleuchtungsstärke","unit":"lx","sensorType":"TSL45315","icon":"osem-brightness","_id":"585120e8d014d4637b9a9037"},{"title":"UV-Intensität","unit":"μW/cm²","sensorType":"VEML6070","icon":"osem-brightness","_id":"585120e8d014d4637b9a9036"}],"loc":[{"_id":"585120e8d014d4637b9a903b","geometry":{"coordinates":[-52.00130614651124,-34.83263387480783],"type":"Point"},"type":"Feature"}]}
 */
...
boxSchema.statics.initNew = function (req) {
  ...
  // there were no validationErrors.. return unsaved box document
  return newBox.save();
};
...
boxSchema.statics.findMeasurementsOfBoxesStream = function (boxQuery, phenomenon, from, to, columns, order) {
  ...
  return this.find(boxQuery)
    ...
    .then(function (boxData) {
      ...
      return Measurement.find({
        ...
        .cursor({ batchSize: 500, lean: true, sort: order })
        .pipe(transformer);
    });
};
