...
const retrieveParameter = function (parameterName, paramDataType, defaultValueOrRequired, allowedValues) {
  return function (req, res, next) {
    ...
    if (checkParamAllowed(param, allowedValues)) {
      setUserParam(req, parameterName[0], (paramIsArray === true ? param : param[0]));
...
module.exports = {
  ...
  GT_DATA_MULTI_ALLOWED_COLUMNS: ['createdAt', 'value', 'lat', 'lon', 'unit', 'boxId', 'sensorId', 'phenomenon', 'sensorType', 'boxName', 'exposure']
};
