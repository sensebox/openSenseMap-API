...
const castParam = function castParam (param, paramDataType, dataTypeIsArray) {
  ...
  case 'ISO8601':
    ...
    break;
  case 'String':
    param = param.map(p => p.toString().trim());
    break;
  }
...
// name: String
// aliases: String[]
// dataType: ['String', ['String'], 'Number', ['Number'] 'object', ['object'], 'ISO8601', ['ISO8601'], 'as-is'] // default: String 'as-is' disables casting and lets restify cast the value
