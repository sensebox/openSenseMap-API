...
const initRoutes = function initRoutes (server) {
  ...
  server.post({ path: `${config.userPath}/signin` }, authHelpers.checkUsernamePassword, usersController.signIn);
  ...
  server.post({ path: `${config.userPath}/signout` }, usersController.signOut);
