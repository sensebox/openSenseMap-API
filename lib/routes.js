...
const routes = {
  'noauth': [
    ...
    { path: `${config.statisticsPath}/outlier`, method: 'get', handler: statisticsController.getOutlier, reference: 'api-Interpolation-calculateOutlier' },
  ...
  'auth': [
    { path: `${config.userPath}/:boxId`, method: 'get', handler: usersController.validApiKey, reference: 'api-Boxes-validApiKey' },
