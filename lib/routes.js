...
const routes = {
  'noauth': [
    ...
    { path: `${config.userPath}/refresh-auth`, method: 'post', handler: [ usersController.refreshJWT ], reference: 'api-Users-refresh-auth' }
  ],
  'auth': [
    { path: `${config.userPath}/me`, method: 'get', handler: usersController.getUser, reference: 'api-Users-getUser' },
    { path: `${config.userPath}/me`, method: 'put', handler: usersController.updateUser, reference: 'api-Users-updateUser' },
